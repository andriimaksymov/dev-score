  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24">
      <div className="bg-gradient-to-b from-slate-900 to-slate-950 rounded-[4rem] p-8 md:p-20 text-center border border-slate-800 relative overflow-hidden">
        ...
        <Heart
          className="mx-auto mb-8 text-emerald-500 drop-shadow-[0_0_20px_rgba(16,185,129,0.3)]"
          size={64}
        />
        ...
        <p className="max-w-2xl mx-auto text-slate-400 mb-12 text-lg leading-relaxed">
          Unlike competitors charging $50-200/month, this tool is built as a portfolio project to
          showcase production-ready full-stack development. No subscriptions. No paywalls.
        </p>
          ...
          <div className="text-left space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-300 font-medium">
                Multi-source analysis (GitHub + LinkedIn + CV)
              </span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle2 className="text-emerald-500 flex-shrink-0" size={20} />
            ...
            <div className="flex items-center gap-3">
              <CheckCircle2 className="text-emerald-500 flex-shrink-0" size={20} />
              <span className="text-slate-300 font-medium">
                4-metric scoring with actionable insights
              </span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle2 className="text-emerald-500 flex-shrink-0" size={20} />
              <span className="text-slate-300 font-medium">
                Privacy-first (no long-term data storage)
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-16 border-t border-slate-800/50 flex flex-wrap justify-center gap-12 grayscale opacity-40">
          <div className="flex items-center gap-2 font-black tracking-tighter text-xl text-white italic">
            React 18
          </div>
          <div className="flex items-center gap-2 font-black tracking-tighter text-xl text-white italic">
            NestJS
